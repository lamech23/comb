...
<div className="overflow-x-auto mt-20">
  <p className="whitespace-nowrap px-4 py-2 text-gray-700 text-center" > List of catgories</p>
  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
    <thead className="ltr:text-left rtl:text-right">
      <tr>
        <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">id</th>
        <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Name of Birth</th>
    ...
    <tbody className="divide-y divide-gray-200">
    {
      ...
      <tr key={index}>
        ...
        <button
    class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm text-green-500 hover:text-gray-700 focus:relative"
  >
    <svg
