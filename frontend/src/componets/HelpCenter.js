...
function HelpCenter() {
  ...
  return (
    ...
    <div className='card shadow-lg' id='helpcard'>
    <p className='text-center mt-2 display-3 '>Kausi coustomer care</p>
    <p className= 'text-center mt-2 display-6 mt-5'>How can we help you?</p>


    <form onSubmit={handelSubmit}>
        <div className="mb-3 " id="FormControlInput1">
        <input type="email"
        ...
        <div className="mt-4"id="textArea">
          ...
          />
<button  type='submit' className="btn btn-success mt-3" id='help'  >Submit</button>
