                  ...
                  <div className="modal-content">
                    ...
                    <div className="modal-body text-start ">
                      <form onSubmit={handelSubmit} className="formOne">
                        ...
                        <div className="mb-3">
                          <label className="label-control">Request a Tour</label>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="requestTourYes">
                              Yes
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="requestTourNo">
                              No
                            </label>
                          </div>
                        </div>
                            ...
                            <div className="modal-body text-start">
                              ...
                              <div>
                                <form onSubmit={handelSelect}>
                                  ...
                                  <label className="label-control"> Reason for visit </label>
                                  <textarea
                                      className="form-control"
                                      type="text"
