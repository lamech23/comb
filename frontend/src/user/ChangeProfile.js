        ...
        <div class="bg-white space-y-6">
          <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 text-gray-500 items-center">
            ...
            <form onSubmit={updatingUser} class="md:w-2/3 max-w-sm mx-auto">
              ...
              <button type="submit" class=" mt-2 align-middle inline-flex bg-blue-500 hover:bg-blue-600 text-center px-4 py-2 text-white text-sm font-semibold rounded-lg  shadow-lg">
              <svg
                  fill="none"
          ...
          <div class="md:inline-flex  space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
            <h2 class="md:w-4/12 max-w-sm mx-auto">Change password</h2>
             <form onSubmit={resetPassword} class="md:w-2/3 mx-auto max-w-sm space-y-5">
              <div>
              ...
              <button type="submit" class="align-middle inline-flex bg-blue-500 hover:bg-blue-600 text-center px-4 py-2 text-white text-sm font-semibold rounded-lg  shadow-lg">
              <svg
                  fill="none"
                  class="w-4 text-white mr-2"
                  viewBox="0 0 24 24"
